...
export default function OrderPage() {
  ...
  return (
    <>
      ...
      <div
        className={`${inriaSans.className} px-3 md:px-10 xl:px-12 max-w-7xl mx-auto flex flex-col gap-4 md:flex-row md:gap-5 lg:gap-12 md:my-4 lg:my-5 my-1 pb-20 md:pb-0`}
      >
