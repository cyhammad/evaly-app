    ...
    <>
      ...
      >
        ...
        <div className='mt-5'>
          ...
          {activeTab === 'Shops' && (
            <p className='text-center pt-5'>No Shops at the moment.</p>
          )}
          {activeTab === 'Brands' && (
            <p className='text-center pt-5'>No Brands at the moment.</p>
          )}
        </div>
      </div>
    </>
