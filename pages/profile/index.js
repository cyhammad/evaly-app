        ...
        <div className='flex-1'>
          ...
          <ul className='mt-5 md:mt-10 flex flex-col gap-2 md:gap-3'>
            <li className='flex text-base md:text-lg lg:text-xl'>
              ...
              <span className='flex-1 text-gray-500'>01834419585</span>
            </li>
            <li className='flex text-base md:text-lg lg:text-xl'>
            ...
            <li className='flex text-base md:text-lg lg:text-xl'>
              ...
              <span className='flex-1 text-gray-500'>15 Aug 1998</span>
            </li>
            <li className='flex text-base md:text-lg lg:text-xl'>
              <span className='flex-1'>Member Since:</span>
              <span className='flex-1 text-gray-500'>26 Dec 2020</span>
            </li>
            <li className='flex text-base md:text-lg lg:text-xl'>
  ...
  return (
    <div className='bg-white h-[90vh] md:h-full rounded-md p-4 md:px-14 md:py-5'>
      <p className='text-base md:text-xl text-gray-500'>
        ...
        Keep Evaly updated about your postal address so that you do not miss any
        surprise gift!
      </p>
      <hr className='my-4 border-gray-400 md:my-5' />
      <ul className='mt-7'>
        <li className='text-gray-500'>
          <p className='text-lg text-black font-bold md:text-xl'>Sheikh Swin</p>
          <p>Dhaka</p>
          <p>01834419585</p>
          <div>
            <IconButton>
